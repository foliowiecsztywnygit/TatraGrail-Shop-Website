                  ...
                  {extraBundleItems.map((item, index) => (
                    <div key={item.uid} className="flex items-start space-x-4 border-b border-gray-100 pb-4 last:border-0 last:pb-0 relative">
                      ...
                      <div className="flex-grow">
                        <span className="text-xs font-bold uppercase mb-2 block pr-6">{t(`products.items.${item.product.id}.title`)}</span>
          ...
          <div className="border-t border-gray-200">
            ...
            <div className="border-b border-gray-200">
              ...
              {openAccordion === 'details' && (
                <div className="pb-5 text-sm text-gray-600 leading-relaxed">
                  <p>Sterile aesthetics meet everyday utility. Designed for the avant-garde. Custom heavyweight fabric tailored for an oversized, boxy fit.</p>
                  <ul className="list-disc pl-5 mt-3 space-y-1">
                    <li>Boxy fit</li>
                    <li>Dropped shoulders</li>
                    <li>High ribbed collar</li>
                  </ul>
                </div>
              )}
            </div>
            ...
            <div className="border-b border-gray-200">
              ...
              {openAccordion === 'material' && (
                <div className="pb-5 text-sm text-gray-600 leading-relaxed">
                  <p>100% Premium Cotton. 280 GSM.</p>
                  <p className="mt-2">Prać w 30 stopniach, na lewej stronie. Nie prasować nadruku.</p>
                </div>
              )}
            </div>
            ...
            <div className="overflow-y-auto p-4 space-y-4 flex-grow">
              {allProducts.map(prod => (
                ...
                >
                  ...
                  <div className="flex-grow">
                    <p className="text-xs font-bold uppercase mb-1">{t(`products.items.${prod.id}.title`)}</p>
